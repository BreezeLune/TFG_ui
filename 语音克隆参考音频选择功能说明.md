...
### 预设音色文件位置
- **默认音色**：`./voice_clone/CosyVoice-main/asset/zero_shot_prompt.wav`
- **跨语言音色**：`./voice_clone/CosyVoice-main/asset/cross_lingual_prompt.wav`
...
PRESET_VOICES = {
    ...
    "voice1": "./voice_clone/CosyVoice-main/asset/voice1.wav",  # 新增
    "voice2": "./voice_clone/CosyVoice-main/asset/voice2.wav",  # 新增
}
```

然后将对应的音频文件放到 `./voice_clone/CosyVoice-main/asset/` 目录下即可。
